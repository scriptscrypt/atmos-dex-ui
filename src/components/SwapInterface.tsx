...
//   return (
//     <div
//       className={`w-full max-w-md mx-auto py-6 p-4 rounded-3xl border shadow-lg transition-colors duration-200 ${
//         isDarkMode ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"
//       }`}
//     >
//       <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
//         <TabsList className="grid w-full grid-cols-2 mb-4 rounded-full bg-gray-100 dark:bg-gray-800">
//           <TabsTrigger
//             value="market"
...
//         <div className="space-y-2">
//           <div className="flex justify-between items-center">
//             <span className="text-sm font-medium dark:text-gray-200">Sell</span>
//             <div className="space-x-2">
//               <Button
//                 variant="outline"
//                 size="sm"
...
//               value={sellAmount}
//               onChange={handleSellAmountChange}
//               className="text-right text-2xl rounded-full dark:bg-gray-800 dark:text-white dark:border-gray-700"
//               placeholder="0.0"
//             />
//           </div>
...
//             onClick={handleSwap}
//           >
//             <ArrowUpDown className="h-6 w-6 dark:text-gray-400" />
//             <span className="sr-only">Swap tokens</span>
//           </Button>
//         </div>
...
//         <div className="space-y-2">
//           <div className="flex justify-between items-center">
//             <span className="text-sm font-medium dark:text-gray-200">Buy</span>
//           </div>
//           <div className="flex items-center space-x-2">
//             <TokenSelect
//               token={buyToken}
...
//         {activeTab === "limit" && (
//           <div className="space-y-2">
//             <Label htmlFor="limitPrice" className="dark:text-gray-200">
//               Limit Price
//             </Label>
//             <Input
//               id="limitPrice"
...
//                 onCheckedChange={setIsPostOnly}
//               />
//               <Label htmlFor="post-only" className="dark:text-gray-200">
//                 Post Only
//               </Label>
//             </div>
//           </div>
...
//         <Button
//           variant="outline"
//           className={`pl-3 py-6 rounded-full ${
...
//               variant="ghost"
//               className={`w-full justify-start rounded-full ${
//                 isDarkMode ? "hover:bg-gray-800 text-white" : ""
//               }`}
//               onClick={() => {
//                 onSelect(t);
//                 setOpen(false);
